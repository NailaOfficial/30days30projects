...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-blue-950 relative">
      <div className="absolute inset-0 bg-[url('/n1.jpg')] bg-cover bg-center opacity-50"></div>
      <div className="relative w-full max-w-md mx-auto z-10">
        <Card className="p-6 rounded-2xl border border-yellow-300 shadow-lg backdrop-blur-md">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold text-yellow-300">Weather Widget</CardTitle>
            <CardDescription className="text-blue-950">Search for the current weather condition in your city.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSearch} className="flex items-center gap-2 mt-4">
              ...
              />
              <Button type="submit" disabled={isLoading} className="bg-yellow-300 text-blue-950 px-4 py-2 rounded-2xl shadow-md">
