...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[url('/3.gif')] bg-cover">
      <Card className="w-full max-w-md mx-auto text-center background-color: currentColor;/80 shadow-lg backdrop-blur-md p-6 rounded-2xl border border-gray-300">
        <CardHeader>
          ...
          <CardDescription className="text-gray-800">Search for the current weather condition in your city.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSearch} className="flex items-center gap-2 mt-4">
            ...
            />
            <Button type="submit" disabled={isLoading} className="bg-yellow-300 text-gray-800 px-4 py-2 rounded-2xl shadow-md">
